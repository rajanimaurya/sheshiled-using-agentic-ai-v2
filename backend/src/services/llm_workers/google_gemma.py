# ─────────────────────────────────────────────────────────────────────────────
# SheShield — LLM Worker: Google Gemma 3 27B (HuggingFace Router)
# Source: LLM-Testing/google_gemma.py — koi change nahi, sirf import path fix kiya
# ─────────────────────────────────────────────────────────────────────────────
...
class AISafetyService:
    ...
    async def get_safety_report(location: str, travel_time: str, intent: str = "general"):
        ...
        if not location or len(location.strip()) < 2:
            return "Error: give a correct location."
